...
#Maybe put a slider on the html to select dates

# something with select_related() to select the dates/hours for each "person" obeject


#on views: convert date to str ustin strftime
  #          convert clock_in/out to strings
  #          concatenate them into one string in a datetime format and convert them to date time using strptime and save() to the clock_in/out vars in the models.py
  ...
  # total_hours = 0
    ...
    #         total_hours = total_hours + i.duration
    #     user.weekmonthhours.totalWeekHours=total_hours
    #     print("Total Hours: ", total_hours)

    # print("VALIDATION SUCCESS!")
            # print("NAME: ", form.cleaned_data['name'])
            # print("Clock In: ", form.cleaned_data['clock_in'])
            # print("Clock Out: ", form.cleaned_data['clock_out'])
